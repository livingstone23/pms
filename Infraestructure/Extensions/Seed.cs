...
public static class Seed
{
    ...
    private static void Ticket(ModelBuilder modelBuilder)
    {
        ...
        var ticktes = new[]
        {
            ...
            new Ticket { TicketId = 3, Summary = "Ticket 3", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 3", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 6, Summary = "Ticket 6", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 6", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 9, Summary = "Ticket 9", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 9", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 12, Summary = "Ticket 12", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 12", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 15, Summary = "Ticket 15", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 15", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 18, Summary = "Ticket 18", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 18", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 21, Summary = "Ticket 21", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 21", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 24, Summary = "Ticket 24", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 24", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 27, Summary = "Ticket 27", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 27", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 30, Summary = "Ticket 30", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 30", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 33, Summary = "Ticket 33", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 33", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 36, Summary = "Ticket 36", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 36", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 39, Summary = "Ticket 39", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 39", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 42, Summary = "Ticket 42", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 42", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 45, Summary = "Ticket 45", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 45", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
            ...
            new Ticket { TicketId = 48, Summary = "Ticket 48", ProductId = 3, CategoryId = 3, PriorityId = 3, Description = "Description 48", RaisedDate = DateTime.Now, ExpectedDate = DateTime.Now.AddDays(1), AssignedToId = user1, RaisedBy = user1, Status = "CLOSED" },
